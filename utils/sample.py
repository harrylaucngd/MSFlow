...
def cond_generate_mols(model, cond, guidance_scale=1.5, num_samples = 1000, steps = 224 ,path = path, seq_len=max_len,source_distribution='uniform',mask_token_id=0, device = 'cuda',temperature = temperature):
