...
from src.mist.data import data
...
class RawMolFeaturizer:
    """Return SMILES and InChIKey instead of fingerprints."""

    @staticmethod
    def featurize(mol, **kwargs):
        """Return SMILES and InChIKey."""
        return {
    ...
    @staticmethod
    def collate_fn(objs):
        """Collate a list of mol dicts into batch dict."""
        smiles_list = [o["smiles"] for o in objs]
        inchikey_list = [o["inchikey"] for o in objs]
        return {
            "smiles": smiles_list,
